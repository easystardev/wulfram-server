...
class ConfigMixin:
    ...
    def _init_replication_config(self):
        ...
        # Broadcasting a CARGO_BOX (type 0x13) entity: build_update_array_create_tank now
        # writes the type-0x13 DEFINITION field (network quantizer entry 4 -> entity+0xDC
        # contained building type), so the bitstream stays aligned on the OG client. Was
