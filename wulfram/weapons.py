...
class BehaviorSlot(IntEnum):
    """Behavior slot indices (empirical mapping as of 2026-01-30).

    These are INPUT behavior slots (0-21), not weapon/ammo slots.
    The weapon cooldown code references weapon slots 0 and 11, which
    are different from these input behavior slots.
    """
    UNUSED0 = 0
